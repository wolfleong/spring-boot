...
public abstract class AutoConfigurationPackages {
	...
	/**
	 * 是 AutoConfigurationPackages 的内部类，实现 ImportBeanDefinitionRegistrar、DeterminableImports 接口，注册器，
	 * 用于处理 @AutoConfigurationPackage 注解
	 *
